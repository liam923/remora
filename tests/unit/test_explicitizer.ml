...
let%expect_test "check explicitizing" =
       ...
       (Map
        ((args
         ...
         (body
          (TermApplication
           ((func (Ref ((id ((name f) (id 46))))))
            (args (((id ((name +arg1) (id 47)))) ((id ((name +arg2) (id 45))))))
            (type' ((element (Literal IntLiteral)) (shape ()))))))
       ...
       (Map
        ((args
         ...
         (body
          (TermApplication
           ((func (Ref ((id ((name f) (id 46))))))
            (args (((id ((name +arg1) (id 47)))) ((id ((name +arg2) (id 48))))))
            (type' ((element (Literal IntLiteral)) (shape ()))))))
         (frameShape ((Add ((const 3) (refs ())))))
         (type'
          (Arr
          ...
          (Map
           ((args
             (((binding ((name +arg1) (id 49)))
               (value (Ref ((id ((name +arg1) (id 48)))))))))
            (body
             (TermApplication
              ((func (Ref ((id ((name f) (id 46))))))
               (args
                (((id ((name +arg1) (id 49)))) ((id ((name +arg2) (id 47))))))
               (type' ((element (Literal IntLiteral)) (shape ()))))))
       ...
       (Map
        ((args
         ...
         (body
          (TermApplication
           ((func (Ref ((id ((name f) (id 46))))))
            (args (((id ((name +arg1) (id 44)))) ((id ((name +arg2) (id 47))))))
            (type' ((element (Literal IntLiteral)) (shape ()))))))
         (frameShape ((Add ((const 3) (refs ())))))
         (type'
          (Arr
    ...
    (Map
     ((args
       (((binding ((name foo) (id 44)))
         (value (Scalar ((element (Literal (IntLiteral 1)))))))))
      (body (Ref ((id ((name foo) (id 44)))))) (frameShape ())
         ...
         (body
          (TermApplication
           ((func (Ref ((id ((name f) (id 49))))))
            (args (((id ((name a) (id 47)))) ((id ((name b) (id 48))))))
            (type' ((element (Literal IntLiteral)) (shape ()))))))
         (frameShape ())
         (type' (Arr ((element (Literal IntLiteral)) (shape ())))))))
      (frameShape ()) (type' (Arr ((element (Literal IntLiteral)) (shape ())))))) |}];
          ...
          (Map
           ((args
             (((binding ((name a) (id 50)))
               (value (Ref ((id ((name a) (id 47)))))))))
            (body
             (TermApplication
              ((func (Ref ((id ((name f) (id 49))))))
               (args (((id ((name a) (id 50)))) ((id ((name b) (id 48))))))
               (type' ((element (Literal IntLiteral)) (shape ()))))))
            (frameShape ((Add ((const 2) (refs ())))))
            (type'
             (Arr
    ...
    (Map
     ((args
      ...
      (body
       (Map
        ((args
          (((binding ((name f) (id 47))) (value (Ref ((id ((name f) (id 46)))))))))
         (body
          (TermApplication
       ...
       (Map
        ((args
         ...
         (body
          (TermApplication
           ((func (Ref ((id ((name f) (id 47))))))
            (args (((id ((name +arg1) (id 48)))) ((id ((name +arg2) (id 45))))))
            (type' ((element (Literal IntLiteral)) (shape ()))))))
         (frameShape ((Add ((const 3) (refs ())))))
         (type'
          (Arr
  ...
  [%expect
    ...
    (Map
     ((args
       (((binding ((name index-value) (id 47)))
         (value
          (Frame
           ((dimensions (3))
            (elements
       ...
       (IndexLet
        ((indexArgs
          (((indexBinding ((name i) (id 44)))
            (indexValue (Runtime (Ref ((id ((name index-value) (id 47)))))))
            (sort Dim))))
         (body
          (Scalar
           ((element
                ...
                (Map
                 ((args
                   (((binding ((name f) (id 46)))
                    ...
                    ((binding ((name replicate-value) (id 45)))
                     (value (Scalar ((element (Literal (IntLiteral 5)))))))))
                  (body
                   (TermApplication
                    ((func (Ref ((id ((name f) (id 46))))))
                     (args (((id ((name replicate-value) (id 45))))))
                     (type'
                      ((element (Literal IntLiteral))
                       (shape
                        ((Add ((const 0) (refs ((((name i) (id 44)) 1))))))))))))
